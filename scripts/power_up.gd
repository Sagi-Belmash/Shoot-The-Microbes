...
@onready var extra_life_img = preload("res://assets/sprites/ship_on.svg")
@onready var triple_shot_img = preload("res://assets/sprites/ship_on.svg")
@onready var slow_time_img = preload("res://assets/sprites/ship_on.svg")
@onready var shield_img = preload("res://assets/sprites/ship_on.svg")
